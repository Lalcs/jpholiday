...
class TestYear2019(unittest.TestCase):
	...
	def test_count_month(self):
		...
		self.assertEqual(len(jpholiday.month_holidays(2019, 4)), 1)
		self.assertEqual(len(jpholiday.month_holidays(2019, 5)), 4)
		...
		self.assertEqual(len(jpholiday.month_holidays(2019, 10)), 1)
	...
	def test_count_year(self):
		...
		2019年祝日数
		"""
		self.assertEqual(len(jpholiday.year_holidays(2019)), 18)
